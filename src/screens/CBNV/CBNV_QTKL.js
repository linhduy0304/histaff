...
class CBNV_QTKL extends Component {
	constructor(props) {
		super(props);
		this.state = {
		data: []
	...
	componentWillMount = () => {
		this.props.getStaff(this.props.profile.user.EMPLOYEE_ID, 'discipline') //ky luat
	};
...
export default connect(mapStateToProps, mapDispatchToProps)(CBNV_QTKL)
